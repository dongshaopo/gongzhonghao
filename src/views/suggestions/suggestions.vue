...
<template>
  <div class="suggestions">
    <div class="ad_img"><img src="~@/assets/images/banner_tsjy@2x.png"></div>
    <div class="user_info">
    	<div class="list">
...
.suggestions{
 ...
 .list_text{
 	...
 	.list{
 		...
 		.zd_desc{flex:1; height:88px; line-height:88px; text-align: right; padding-right:30px; font-size: 30px;font-family: Source Han Sans CN;font-weight: 400;}
 	}
 	.button_submit{
 		width:100%;
 		float: left;
